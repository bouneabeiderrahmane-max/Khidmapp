...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'management_fee_mru' => $this->management_fee_mru,
            'delivery_zone' => $this->delivery_zone,
            'weight_tier' => $this->weight_tier,
            'weight_tier_label' => $this->weight_tier !== null ? __('khidmapp.weight_tier.'.$this->weight_tier) : null,
            'extra_weight_kg' => $this->extra_weight_kg,
