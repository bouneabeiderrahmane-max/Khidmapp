...
Voir `docs/PLAN.md` section 7/7bis/7ter/7quater/7quinquies/7sexies/7septies/7octies/7nonies/7decies/7undecies pour le détail de chaque sprint livré, et section 8 pour les points encore ouverts (granularité fine des permissions, opérateur SMS à choisir, connecteur de synchronisation réel et service de traduction à choisir, vraie intégration Bankily et Firebase Cloud Messaging à obtenir, délais SLA logistiques indicatifs non mesurés et pas encore reliés aux notifications, FAQ réservée à l'administrateur) avant le Sprint 11.
